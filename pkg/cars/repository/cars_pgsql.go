...
func (p PgRepo) GetCarReservation(ctx context.Context, carId int) bool {
	_, err := p.conn.QueryContext(ctx, isReservedSQL, carId)
	if err != nil {
		return false
	}
